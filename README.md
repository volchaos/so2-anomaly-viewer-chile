...
3. Set **Source/Build method** to **GitHub Actions**.
4. Save. Your site will be available at `https://<user>.github.io/<repo>/`.
5. El despliegue estable queda gestionado por el workflow **`.github/workflows/pages_production.yml`** (push a `main`).
...
- No modifica la publicación estable de `main`; la producción la publica **`.github/workflows/pages_production.yml`**.
